package com.med.medinin.circularseekbar;
...
public class CircularSeekBar extends View {
    ...
    private void init(Context context, @Nullable AttributeSet attrs, int defStyle) {
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                com.akaita.android.circularseekbar.R.styleable.CircularSeekBar,
                0,
                0);
        try {
            mEnabled = a.getBoolean(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_enabled, mEnabled);
            mShowIndicator = a.getBoolean(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_showIndicator, mShowIndicator);
            mMinValue = a.getFloat(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_min, mMinValue);
            mMaxValue = a.getFloat(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_max, mMaxValue);
            mSpeedMultiplier = a.getFloat(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_speedMultiplier, mSpeedMultiplier);
            mProgress = a.getFloat(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_progress, mProgress);
            mShowText = a.getBoolean(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_showProgressText, mShowText);
            mRingWidthFactor = a.getFloat(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_ringWidth, mRingWidthFactor);
            mProgressText = a.getString(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_progressText);
            mShowInnerCircle = a.getBoolean(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_showInnerCircle, mShowInnerCircle);
            mRingColor = a.getColor(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_ringColor, mRingColor);
            mInnerCircleColor = a.getColor(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_innerCircleColor, mInnerCircleColor);
            mProgressTextColor = a.getColor(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_progressTextColor, mProgressTextColor);
            mProgressTextSize = Utils.convertDpToPixel(getResources(), a.getFloat(com.akaita.android.circularseekbar.R.styleable.CircularSeekBar_progressTextSize, mProgressTextSize));
        } finally {
            a.recycle();
        }
